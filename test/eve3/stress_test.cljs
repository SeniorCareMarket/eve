(ns eve3.stress-test
  "Stress tests for eve3 data structures.
   Exercises map, vec, set, list at scale to verify correctness
   of the eve3-deftype-based implementations (ISlabIO threaded everywhere)."
  (:require
...
(deftest eve3-vec-2000-elements-test
  (with-parent-atom
    (fn []
      (testing "eve3-vec with 2000 elements"
        (let [n 2000
...
(deftest eve3-vec-5000-elements-test
  (with-parent-atom
    (fn []
      (testing "eve3-vec with 5000 elements"
        (let [n 5000
...
(deftest eve3-vec-assoc-stress-test
  (with-parent-atom
    (fn []
      (testing "eve3-vec many assoc operations"
        (let [n 2000
              v (v3/eve3-vec sio (range n))]
...
(deftest eve3-vec-pop-stress-test
  (with-parent-atom
    (fn []
      (testing "eve3-vec popping from 2000 down to 0"
        (let [n 2000
              v (v3/eve3-vec sio (range n))]
          (bench "vec pop 2000"
            #(loop [current v
...
(deftest eve3-map-2000-entries-test
  (with-parent-atom
    (fn []
      (testing "eve3 hash-map with 2000 entries"
        (let [n 2000
...
(deftest eve3-map-5000-entries-test
  (with-parent-atom
    (fn []
      (testing "eve3 hash-map with 5000 entries"
        (let [n 5000
...
(deftest eve3-map-dissoc-stress-test
  (with-parent-atom
    (fn []
      (testing "eve3 hash-map dissoc stress"
        (let [n 2000
...
(deftest eve3-map-reduce-5000-test
  (with-parent-atom
    (fn []
      (testing "eve3 hash-map reduce 5000 entries"
        (let [n 5000
...
(deftest eve3-set-2000-elements-test
  (with-parent-atom
    (fn []
      (testing "eve3 hash-set with 2000 elements"
        (let [n 2000
...
(deftest eve3-set-5000-elements-test
  (with-parent-atom
    (fn []
      (testing "eve3 hash-set with 5000 elements"
        (let [n 5000
...
(deftest eve3-set-disj-stress-test
  (with-parent-atom
    (fn []
      (testing "eve3 hash-set disj stress"
        (let [n 2000
              s (into (s3/empty-hash-set sio) (range n))]
...
(deftest eve3-set-reduce-5000-test
  (with-parent-atom
    (fn []
      (testing "eve3 hash-set reduce 5000 elements"
        (let [n 5000
              s (into (s3/empty-hash-set sio) (range n))]
...
(deftest eve3-list-2000-elements-test
  (with-parent-atom
    (fn []
      (testing "eve3-list with 2000 elements"
        (let [n 2000
...
(deftest eve3-list-conj-stress-test
  (with-parent-atom
    (fn []
      (testing "eve3-list conj 3000 elements"
        (let [n 3000]
          (bench "list conj 3000"
            #(let [l (reduce conj (l3/empty-list sio) (range n))]
               (is (= n (count l)))
               (is (= (dec n) (first l))))))))))

(deftest eve3-list-pop-stress-test
  (with-parent-atom
    (fn []
      (testing "eve3-list pop 2000 down to 0"
        (let [n 2000
              l (l3/eve3-list sio (range n))]
          (bench "list pop 2000"
            #(loop [current l
                    expected-count n]
               (when (> expected-count 0)
