...
;; Anti-DCE: the `:require` above ensures these namespaces are loaded.
;; Export a truthy value under each key so Closure doesn't strip the ns.
(goog/exportSymbol "eve.deftype_test" true)
(goog/exportSymbol "eve.array_test" true)
(goog/exportSymbol "eve.map_test" true)
(goog/exportSymbol "eve.vec_test" true)
(goog/exportSymbol "eve.list_test" true)
(goog/exportSymbol "eve.set_test" true)
(goog/exportSymbol "eve.large_scale_test" true)
(goog/exportSymbol "eve.epoch_gc_test" true)
(goog/exportSymbol "eve.obj_test" true)
(goog/exportSymbol "eve.batch2_validation_test" true)
(goog/exportSymbol "eve.batch3_validation_test" true)
(goog/exportSymbol "eve.batch4_validation_test" true)
(goog/exportSymbol "eve.deftype.int_map_test" true)
(goog/exportSymbol "eve.deftype.rb_tree_test" true)
(goog/exportSymbol "eve.typed_array_test" true)
(goog/exportSymbol "eve.mem_test" true)
(goog/exportSymbol "eve.mmap_test" true)
(goog/exportSymbol "eve.mmap_worker_test" true)
(goog/exportSymbol "eve.mmap_slab_test" true)
(goog/exportSymbol "eve.mmap_atom_test" true)
(goog/exportSymbol "eve.mmap_atom_e2e_test" true)
(goog/exportSymbol "eve.mmap_domain_test" true)
(goog/exportSymbol "eve.conformance_test" true)
(goog/exportSymbol "eve.fuzz_test" true)
